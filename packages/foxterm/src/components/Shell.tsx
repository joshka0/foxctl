...
function Footer({
  ...
  return (
    ...
    >
      ...
      <text fg={theme.muted}>
        {compact
          ? "1/2/3 scope  h/l pane  j/k Enter  n + m c x / r ? q"
          : "Tab focus  1/2/3 scope  j/k move  Enter open  n context run  + room  m message  c continue  x kill  / filter  a scope  r refresh  ? help  q quit"}
      </text>
    </box>
  );
}
