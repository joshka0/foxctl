...
`check:frontend` runs the shared data typecheck, this GUI build, GUI behavior
tests, foxterm typecheck, and GUI auth gateway typecheck. `unused:frontend`
adds the root oxlint pass.
