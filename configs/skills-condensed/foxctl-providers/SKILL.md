...
foxctl run providers/config --input '{
  "operation": "add-mcp",
  "provider": "claude",
...
# Export config
foxctl run providers/config --input '{"operation": "export", "provider": "claude", "file": "backup.json"}'
...
Full docs: `~/.foxctl/share/configs/providers/skills.json`
