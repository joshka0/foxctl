...
Control Android Emulators via `foxctl run mobile/android`.

## Usage

```bash
foxctl run mobile/android --input '{"operation": "<op>", ...}'
```
...
Full docs: `~/.foxctl/share/configs/skills/foxctl-mobile-android/Skill.md`
