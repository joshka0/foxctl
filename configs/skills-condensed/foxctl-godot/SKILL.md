...
```bash
foxctl run editor/godot --input '{"action": "<action>", ...}'
```
...
foxctl run editor/godot --input '{"action": "node_create", "parent_path": "/root/Main", "node_type": "CharacterBody2D", "node_name": "Player"}'
foxctl run editor/godot --input '{"action": "node_attach_script", "node_path": "/root/Main/Player", "script_path": "res://scripts/player.gd"}'
```

Full docs: `~/.foxctl/share/configs/skills/foxctl-godot/Skill.md`
