...
```bash
agentctl run build/unity --input '{"action": "list_targets"}'
```

### Build Project

```bash
agentctl run build/unity --input '{
  "action": "build",
...
```bash
agentctl run build/unity --input '{"action": "clean"}'
```
...
```bash
agentctl run unity/packages --input '{"operation": "list"}'
```

### Add Package

```bash
agentctl run unity/packages --input '{
  "operation": "add",
...
```bash
agentctl run unity/scenes --input '{"operation": "list"}'
```

### Add Scene

```bash
agentctl run unity/scenes --input '{
  "operation": "add",
...
```bash
agentctl run unity/scenes --input '{"operation": "find"}'
```
...
```bash
agentctl run unity/input --input '{
  "operation": "list_maps",
