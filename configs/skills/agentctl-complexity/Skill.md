...
```bash
# Go
agentctl run code/complexity --input '{"path": ".", "language": "go"}'

# Python
agentctl run code/complexity --input '{"path": ".", "language": "python"}'

# TypeScript
agentctl run code/complexity --input '{"path": ".", "language": "typescript"}'
```
