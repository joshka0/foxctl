...
# Overseer Coordination with foxctl
...
foxctl todo add --title "Task A" --depends-on "task-b-id"
...
foxctl run todo/manage --input '{"operation": "recommend"}'
```
