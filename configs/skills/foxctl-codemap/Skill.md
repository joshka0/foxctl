...
foxctl run codemap/generate --input '{"query": "where is the config loaded"}' --timeout 5m

# Complex query: ~15 minutes
foxctl run codemap/generate --input '{"query": "trace the full auth flow", "depth": 2}' --timeout 15m
```
...
foxctl run codemap/import --input '{
