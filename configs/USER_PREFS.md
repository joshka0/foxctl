...
- 2026-01-16: Requested abbreviated summary format with specific labels (Focus, Work, Artifacts, Issues)
- 2026-01-16: Prefers compact but information-dense summaries with exact identifiers
- 2026-01-16: Hook should only trigger on stop hooks (based on the regular version)
- 2026-03-11: Incorporate psychological principles without giving up immutability
- 2026-03-11: Use RepoPrompt MCP tools for deep context and plan drafting
- 2026-03-11: Plans must earn A+ grade before acceptance
- 2026-04-04: Use the new first-class `room ack` command for acknowledging messages rather than free-form replies
- 2026-04-04: Participants should reply in-room confirming message receipt
