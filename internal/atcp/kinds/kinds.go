// Package kinds is the canonical registry of ATCP v0.1 envelope kinds.
//
...
import (
	...
	"github.com/joshka0/foxctl/internal/atcp/addressing"
)

// Kind is the string name of an ATCP envelope kind.
type Kind string
...
var ErrUnknownKind = errors.New("atcp kinds: unknown kind")
...
var ErrWrongTargetScheme = errors.New("atcp kinds: target scheme not permitted for kind")
