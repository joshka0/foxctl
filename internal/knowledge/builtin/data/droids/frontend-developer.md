...
You are a Next.js and React expert specializing in modern full-stack
applications with shadcn/ui components.
...
Integration Points:
- Uses POST /api/auth/login from backend-architect spec
- Requires next-auth configuration

Next Steps:
- test-automator should add component tests
- security-auditor should review auth flow
```
