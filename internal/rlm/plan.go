...
func buildPlanWithQueryPlan(route RouteProfile, mode PlanMode, qp QueryPlan) Plan {
		...
		plan.Phases = []Phase{
			{
				...
				AllowedTools:   []string{"plan_context_query", "gather_context", "retrieve_code", "retrieve_mixed"},
			...
			},
			{
				...
				AllowedTools:   []string{"aggregate_evidence_refs", "evidence_ledger", "load_evidence_ref", "retrieve_code"},
				RequireOneOf:   []string{"aggregate_evidence_refs", "evidence_ledger", "load_evidence_ref"},
				MaxIterations:  3,
				RequireToolUse: true,
			},
			{
				...
				AllowedTools:   []string{"aggregate_evidence_refs", "evidence_ledger", "load_evidence_ref", "retrieve_code", "retrieve_mixed"},
				RequireOneOf:   []string{"aggregate_evidence_refs", "evidence_ledger", "load_evidence_ref"},
				MaxIterations:  2,
				RequireToolUse: true,
			},
		...
		plan.Phases = []Phase{
			{
				...
				AllowedTools:   []string{"plan_context_query", "gather_memory_context", "gather_context", "retrieve_memory", "retrieve_context", "retrieve_task"},
				RequireOneOf:   []string{"gather_memory_context", "gather_context"},
				MaxIterations:  3,
				RequireToolUse: true,
			},
			{
				Name:           "verification",
				Objective:      "Build an evidence ledger for the strongest recalled evidence and run a targeted fallback if the ledger reports missing required slots.",
				AllowedTools:   []string{"evidence_ledger", "aggregate_evidence_refs", "load_evidence_ref", "plan_context_query", "gather_memory_context", "gather_context", "retrieve_memory", "retrieve_context"},
		...
		plan.Phases = []Phase{
			{
				...
				AllowedTools:   []string{"plan_context_query", "gather_memory_context", "gather_context", "retrieve_mixed", "retrieve_code", "retrieve_memory", "retrieve_context", "retrieve_task"},
				RequireOneOf:   []string{"gather_context"},
				MaxIterations:  3,
				RequireToolUse: true,
			},
			{
				Name:           "inspection",
				Objective:      "Aggregate or cross-check the strongest evidence from all lanes.",
				AllowedTools:   []string{"evidence_ledger", "aggregate_evidence_refs", "load_evidence_ref", "retrieve_code", "retrieve_memory"},
				RequireOneOf:   []string{"evidence_ledger", "aggregate_evidence_refs", "load_evidence_ref"},
				MaxIterations:  2,
				RequireToolUse: true,
			},
		}
	case RouteProfileEvidenceAudit:
		plan.Phases = []Phase{
			...
			{
				Name:           "verification",
				Objective:      "Aggregate or verify audited evidence refs with explicit accept/reject binding when possible.",
				AllowedTools:   []string{"evidence_ledger", "aggregate_evidence_refs", "load_evidence_ref", "retrieve_code", "retrieve_memory"},
				RequireOneOf:   []string{"evidence_ledger", "aggregate_evidence_refs", "load_evidence_ref"},
				MaxIterations:  2,
				RequireToolUse: true,
