...
| Interface layers | `internal/web`, `internal/interfaces/chatadapter`, `internal/openapi`, `internal/providers` | API/server surfaces and external platform integrations | `docs/general/api-server.md`, `docs/architecture/chat-platform-adapter.md` |
