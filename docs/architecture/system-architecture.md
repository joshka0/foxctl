...
| State and persistence | `internal/storage/*`, `internal/v2/adapters/turso/*` | Durable stores, CAS, mailbox/task/session persistence, v2 events and projections. The old `internal/v2/adapters/libsql` path remains only in `main` history at `938733293b81c9be8787e15300661cf587baa8af`; current v2 SQL adapter work uses Turso naming. | `docs/general/storage.md`, `docs/architecture/postgres-storage.md` |
