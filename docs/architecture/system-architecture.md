...
| Retrieval and indexing | `internal/indexing/*`, `internal/retrieval`, `internal/intelligence/codecontext`, `internal/codemap` | Semantic/symbol/repo indexing and context extraction | `docs/general/search.md`, `docs/general/repoindex.md` |
