...
| `internal/runtime/execution/agentmanager` | Legacy spawn/kill and runtime management fallback | `internal/v2/services/{spawn,kill,list,run}` | Partial replacement |
...
- clarify generic tooling ownership in `internal/tooling`,
  `internal/tooling/skillrun`, `internal/tooling/tools/*`, and `internal/adapters/skillslib/*`
