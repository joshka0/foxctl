...
| `internal/indexing`, `internal/retrieval`, `internal/intelligence/codecontext`, `internal/intelligence/codemap`, `internal/refactor` | Retrieval and code intelligence | current intelligence family |
...
| `internal/indexing/*`, `internal/retrieval`, `internal/intelligence/codecontext`, `internal/intelligence/codemap`, `internal/refactor` | Intelligence and retrieval plane |
...
| search/query/recall | `internal/retrieval`, `internal/intelligence/retrieval/v2`, `internal/intelligence/repoquery`, `internal/searchquery`, `internal/searchrank` | keep as the query and recall slice |
