...
| `internal/runtime` | Runtime-owned execution, orchestration support, daemon hosting, terminal, hooks, and observability | `runtime/engine`, `runtime/runservice`, `runtime/orchestration`, `runtime/daemon`, `runtime/terminal`, `runtime/hooks`, `runtime/observability` |
