...
| ContextWiki, context engine, and context | `/context/contextwiki`, `/context/context-engine`, `/context/obsidian-bridge` | `docs/architecture/context-architecture.md`, `internal/context/contextengine`, `internal/storage/contextengine` | current | Keep dual-plane language precise and separate ContextWiki from typed evidence substrate |
