...
| Retrieval/index/search | `internal/indexing/*`, `internal/retrieval`, `internal/codecontext`, `internal/codemap` | `docs/general/search.md`, `docs/general/repoindex.md` | Covered | Keep index/search docs current with indexer changes |
