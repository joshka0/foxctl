...
| Context/observability | `internal/context/updater`, `internal/observability`, `internal/hooks` | `docs/observability/README.md`, `docs/general/hooks.md` | Partial | Documented in `docs/general/context-and-observability.md` |
