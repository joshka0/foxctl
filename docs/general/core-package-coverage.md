...
|------|----------------|--------------|----------|--------------------|
| Agent runtime/orchestration | `internal/agent`, `internal/runtime/daemon`, `internal/execution`, `internal/runtime/engine` | `docs/general/agent-daemon.md`, `docs/architecture/system-architecture.md` | Partial | Keep architecture canonical; maintain runtime details in `docs/general/runtime-orchestration.md` |
| Session/run pipeline | `internal/context/sessionkit`, `internal/skillrun`, `internal/runtime/runservice`, `internal/queue`, `internal/runtime/orchestration/workflow` | `docs/architecture/system-architecture.md` | Partial | Documented in `docs/general/runtime-orchestration.md` |
