...
|------|----------------|--------------|----------|--------------------|
| Agent runtime/orchestration | `internal/agent`, `internal/runtime/daemon`, `internal/execution`, `internal/engine` | `docs/general/agent-daemon.md`, `docs/architecture/system-architecture.md` | Partial | Keep architecture canonical; maintain runtime details in `docs/general/runtime-orchestration.md` |
