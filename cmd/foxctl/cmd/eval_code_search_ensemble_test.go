...
func TestLoadCheckedInCodeSearchEnsembleDataset(t *testing.T) {
	...
	path := filepath.Join("..", "..", "..", "testdata", "evals", "code-search-ensemble", "foxctl-repo-grounded.jsonl")
...
func TestLoadCheckedInCodeSearchTraceSymbolDataset(t *testing.T) {
	...
	path := filepath.Join("..", "..", "..", "testdata", "evals", "code-search-ensemble", "foxctl-trace-symbol.jsonl")
	cases, err := loadPromptEvalCases(path)
	if err != nil {
		t.Fatalf("loadPromptEvalCases() error = %v", err)
	}
...
func TestLoadCheckedInCodeSearchChangeImpactDataset(t *testing.T) {
	...
	path := filepath.Join("..", "..", "..", "testdata", "evals", "code-search-ensemble", "foxctl-change-impact.jsonl")
	cases, err := loadPromptEvalCases(path)
	if err != nil {
		t.Fatalf("loadPromptEvalCases() error = %v", err)
	}
...
func TestLoadCheckedInCodeSearchBridgeEsotericDataset(t *testing.T) {
	...
	path := filepath.Join("..", "..", "..", "testdata", "evals", "code-search-ensemble", "foxctl-bridge-esoteric.jsonl")
	cases, err := loadPromptEvalCases(path)
	if err != nil {
		t.Fatalf("loadPromptEvalCases() error = %v", err)
	}
