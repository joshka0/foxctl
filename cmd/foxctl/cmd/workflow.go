...
import (
	...
	"github.com/joshka0/foxctl/internal/runtime/orchestration/workflow"
...
func newWorkflowCommand() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long: `Workflows chain multiple foxctl skills into automated pipelines.
...
Examples:
  ...
  foxctl workflow run analyze-code --input '{"path": "./src"}'

  # Run a workflow from a file
  foxctl workflow run ./my-workflow.yaml --input '{"path": "."}'

  # Run with input from file
  foxctl workflow run analyze-code --input-file params.json`,
