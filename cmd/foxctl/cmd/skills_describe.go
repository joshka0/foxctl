...
func newSkillsDescribeCommand() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return protocol.WriteOK(cmd.OutOrStdout(), "foxctl.skills.describe", details, protocol.WithSource("run"))
		},
	}
	return cmd
}
...
func newSkillsHelpCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return protocol.WriteOK(cmd.OutOrStdout(), "foxctl.skills.help", help, protocol.WithSource("cli"))
		},
	}
