...
import (
	...
	"github.com/joshka0/foxctl/internal/context/knowledge/builtin"
...
Examples:
  foxctl workspace init                    # Initialize with core agents
  foxctl workspace init --agents all       # Initialize with all agents
  foxctl workspace init --agents core,factory  # Initialize with specific sets
  foxctl workspace init --dry-run          # Preview what would be created`,
