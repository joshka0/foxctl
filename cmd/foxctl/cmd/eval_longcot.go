...
func longCoTChildExtractPhases() []rlmruntime.REPLRunnerPhase {
	return []rlmruntime.REPLRunnerPhase{{
		...
		Prompt: strings.Join([]string{
			...
			"status: solved",
			"answer: <facts-only extraction>",
			"checks: extracted requested outputs and dependency constraints",
		}, "\n"),
		MaxIterations:   1,
		Final:           true,
	...
	phases = append(phases,
		...
		rlmruntime.REPLRunnerPhase{
			...
			Prompt: strings.Join([]string{
				...
				"answer: <verification pass/fail summary>",
				"checks: <one compact original-constraint substitution check>",
			}, "\n"),
			MaxIterations:   1,
			Final:           true,
			FinalOutputKind: "child_summary",
...
func longCoTChildReducePhases() []rlmruntime.REPLRunnerPhase {
	return []rlmruntime.REPLRunnerPhase{{
		...
		Prompt: strings.Join([]string{
			...
			"Return compact structured lines only:",
			"status: solved|partial|blocked",
			"answer: <solution line or empty>",
			"checks: <verification pass or concrete failed constraint>",
		}, "\n"),
		MaxIterations:   1,
		Final:           true,
		FinalOutputKind: "child_summary",
