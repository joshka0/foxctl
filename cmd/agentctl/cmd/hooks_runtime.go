...
import (
	...
	"github.com/jkatigb/agentctl/internal/runtime/hooks/analysisflow"
	"github.com/jkatigb/agentctl/internal/runtime/hooks/contextflow"
	"github.com/jkatigb/agentctl/internal/runtime/hooks/inboxflow"
	"github.com/jkatigb/agentctl/internal/runtime/hooks/lifecycle"
	"github.com/jkatigb/agentctl/internal/runtime/hooks/memoryflow"
	"github.com/jkatigb/agentctl/internal/runtime/hooks/operationalflow"
	"github.com/jkatigb/agentctl/internal/runtime/hooks/promptflow"
	"github.com/jkatigb/agentctl/internal/runtime/hooks/taskflow"
...
func defaultGraphMaintenanceLogFile() (string, error) {
	...
	dir := filepath.Join(home, ".agentctl", "logs", "hooks")
