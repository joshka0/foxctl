...
func TestRegisterParticipantTransportUpdatesExistingMember(t *testing.T) {
	...
	socketPath := "/tmp/test-agentctl/pane/test-transport-room/claude-a.sock"
...
func TestRegisterParticipantTransportCreatesNewMember(t *testing.T) {
	...
	socketPath := "/tmp/test-agentctl/pane/test-transport-new/droid-a.sock"
	cmd, _ := newRoomTestCommand(ctx)
...
func TestRegisterParticipantTransportConcurrentExistingMembersDoNotClobberEachOther(t *testing.T) {
	...
	socketA := "/tmp/test-agentctl/pane/test-transport-concurrent/claude-a.sock"
	socketB := "/tmp/test-agentctl/pane/test-transport-concurrent/gemini-a.sock"
