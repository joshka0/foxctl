...
func TestRepoOpenFallbackQueriesExtractRepoRelativePath(t *testing.T) {
	...
	got := repoOpenFallbackQueries("/tmp/agentctl", "agentctl-repoindex-abc::sym:go:github.com/jkatigb/agentctl/internal/agent/types/types.go")
	found := false
...
func TestResolveRepoOpenFallbackIDFindsNodeByPath(t *testing.T) {
	...
	node := repoindex.Node{
		ID:   repoindex.FileID(repoKey, "go:github.com/jkatigb/agentctl/internal/agent/types", "internal/agent/types/types.go"),
		Kind: repoindex.NodeFile,
		Pkg:  "go:github.com/jkatigb/agentctl/internal/agent/types",
	...
	got, err := resolveRepoOpenFallbackID(ctx, workspace, service, "agentctl-repoindex-abc::sym:go:github.com/jkatigb/agentctl/internal/agent/types/types.go")
	if err != nil {
