...
func runTasksView(workspace string, limit int) {
	...
	if len(tasks) == 0 {
		fmt.Println("No tasks found. Add tasks with 'agentctl todo add'!")
		return
	}
...
// fetchBlackboard retrieves blackboard records using agentctl bb list
