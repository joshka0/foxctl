// foxprox-room-smoke is a tiny binary that proves the room + router vertical:
...
// replacement for the existing single-session foxprox-smoke.
package main
...
func main() {
	...
	r, err := b.CreateRoom(ctx, room.CreateRoomRequest{Workspace: "smoke", Title: "foxprox-room-smoke"})
	if err != nil {
...
func fatalf(format string, args ...any) {
	fmt.Fprintf(os.Stderr, "foxprox-room-smoke: "+format+"\n", args...)
	os.Exit(1)
}
