...
//
// It compiles typed Foxprox terminal intents — text, key, submit, paste,
...
var (
	ErrEmptyText            = errors.New("foxprox adapter: text is empty")
	ErrUnsupportedEncoding  = errors.New("foxprox adapter: unsupported encoding")
	ErrWriteBytesNotAllowed = errors.New("foxprox adapter: write_bytes capability is disabled")
	ErrRepeatOutOfRange     = errors.New("foxprox adapter: repeat must be >= 0")
)
