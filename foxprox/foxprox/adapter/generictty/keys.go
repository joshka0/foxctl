...
var ErrUnknownKey = errors.New("foxprox adapter: unknown key name")

// ErrInvalidModifier is returned when a Modifiers element is unrecognised.
var ErrInvalidModifier = errors.New("foxprox adapter: invalid modifier")
...
var ErrModifierNotApplicable = errors.New("foxprox adapter: modifier not applicable to this key")
