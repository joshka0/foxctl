// Package lease implements per-session input leases for Foxprox.
//
...
var (
	ErrInvalidSession = errors.New("foxprox lease: SessionID is required")
	ErrInvalidScope   = errors.New("foxprox lease: Scope is required")
	ErrInvalidOwner   = errors.New("foxprox lease: Owner is required")
	ErrInvalidTTL     = errors.New("foxprox lease: TTL must be positive")
	ErrLeaseHeld      = errors.New("foxprox lease: scope is already held (use Preempt to override)")
	ErrUnknownLease   = errors.New("foxprox lease: unknown lease id")
	ErrManagerStopped = errors.New("foxprox lease: manager is stopped")
)
