...
// broker subsystem that composes the manager with an foxprox_sessions table.
...
var ErrSessionNotFound = errors.New("foxprox session: not found")

// ErrManagerClosed is returned by Create after Stop.
var ErrManagerClosed = errors.New("foxprox session: manager is stopped")
