// Package room implements Foxprox's in-memory Room Manager.
//
...
// WITHOUT persistence — the canonical schema (foxprox_rooms /
// foxprox_room_members, plan §5a.7) lands in a follow-up once the wire
...
// Room is the durable coordination scope. Fields mirror the foxprox_rooms row
...
var (
	ErrRoomNotFound        = errors.New("foxprox room: not found")
	ErrRoomArchived        = errors.New("foxprox room: archived")
	ErrMemberNotFound      = errors.New("foxprox room: member not found")
	ErrSessionAlreadyBound = errors.New("foxprox room: session already bound to an active member")
	ErrAgentAlreadyInRoom  = errors.New("foxprox room: agent already has an active member in this room")
	ErrWorkspaceRequired   = errors.New("foxprox room: workspace is required")
	ErrSessionRequired     = errors.New("foxprox room: session_id is required")
	ErrAgentRequired       = errors.New("foxprox room: agent_id is required")
)
