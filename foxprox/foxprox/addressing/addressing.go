// Package addressing parses and constructs Foxprox target URIs of the form
// <scheme>:<id>. See docs/Foxprox-v0.1.md §8.
//
...
// Address is a parsed Foxprox target URI.
type Address struct {
	Scheme Scheme
	ID     string
}
...
var (
	ErrEmptyAddress   = errors.New("foxprox address: empty input")
	ErrMissingScheme  = errors.New("foxprox address: missing scheme delimiter ':'")
	ErrEmptyScheme    = errors.New("foxprox address: scheme is empty")
	ErrEmptyID        = errors.New("foxprox address: id is empty")
	ErrUnknownScheme  = errors.New("foxprox address: unknown scheme")
	ErrWrongScheme    = errors.New("foxprox address: scheme does not match expected")
	ErrInvalidIDChars = errors.New("foxprox address: id contains forbidden characters")
)
...
// IsKnown reports whether s is one of the registered Foxprox schemes.
