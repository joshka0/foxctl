## Core handler for GodotAIBridge - handles core node and scene operations.
extends RefCounted
class_name CoreHandler
...
func handle(action: String, params: Dictionary) -> Dictionary:
	match action:
		...
		_:
			return _error_response("EACTION", "CoreHandler: Unknown action: " + action, "")


func add_error(message: String, source: String = "", severity: String = "error") -> void:
...
func _handle_scene_tree(params: Dictionary) -> Dictionary:
...
func _handle_node_inspect(params: Dictionary) -> Dictionary:
...
func _handle_node_create(params: Dictionary) -> Dictionary:
...
func _handle_node_delete(params: Dictionary) -> Dictionary:
	var node_path: String = params.get("node_path", "")
	var dry_run: bool = params.get("dry_run", false)
...
func _handle_node_rename(params: Dictionary) -> Dictionary:
	var node_path: String = params.get("node_path", "")
...
func _handle_node_reparent(params: Dictionary) -> Dictionary:
	var node_path: String = params.get("node_path", "")
...
func _handle_node_set_prop(params: Dictionary) -> Dictionary:
	var node_path: String = params.get("node_path", "")
...
func _handle_node_attach_script(params: Dictionary) -> Dictionary:
	var node_path: String = params.get("node_path", "")
...
func _handle_signal_connect(params: Dictionary) -> Dictionary:
...
func _handle_class_info(params: Dictionary) -> Dictionary:
...
func _handle_ensure_node(params: Dictionary) -> Dictionary:
...
func _handle_search_nodes(params: Dictionary) -> Dictionary:
...
func _handle_focus_node(params: Dictionary) -> Dictionary:
...
func _handle_selection_state() -> Dictionary:
...
func _handle_run_game() -> Dictionary:
...
func _handle_stop_game() -> Dictionary:
...
func _handle_errors(params: Dictionary) -> Dictionary:
